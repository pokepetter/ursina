...
def terraincast(origin, terrain):
    ...
    origin_vector[2] = origin_vector[0] * sin(-angle) + origin_vector[2] * cos(-angle)
    origin = terrain.world_position + origin_vector

    origin -= terrain.world_position + terrain.origin * terrain.world_scale
    origin[0] = (origin[0]/terrain.world_scale_x+.5) * terrain.model.width
    origin[2] = (origin[2]/terrain.world_scale_z+.5) * terrain.model.depth
