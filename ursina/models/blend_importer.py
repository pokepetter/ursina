...
def open_blend(filename, access="rb"):
    ...
    if magic == magic_test:
        print("normal blendfile detected")
        ...
        if magic == magic_test:
            ...
            fs.close()
            print("resetting decompressed file")
...
class BlendFile:
    ...
    def __init__(self, handle):
        print("initializing reading blend-file")
        self.handle = handle
    ...
    def close(self):
        ...
        if self.is_modified:
            if self.is_compressed:
                print("close compressed blend file")
                handle.seek(os.SEEK_SET, 0)
    ...
    def decode_structs(header, block, handle):
        ...
        offset += 4
        print("building #%d structures" % structs_len)
...
class BlendFileHeader:
    ...
    def __init__(self, handle):
        ...
        print("reading blend-file-header")
...
print(open_blend('cube.blend').blocks)
